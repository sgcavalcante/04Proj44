...
urlpatterns = [
    ...
    path('calendario/', calendario_consultas, name='calendario_consultas'),  # Página do calendário
    path('eventos/', eventos_consultas, name='eventos_consultas'),  # Endpoint para os dados do calendário
]
